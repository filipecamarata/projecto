...
<article>
    ...
    <div class="linha"> 
        <a href="dj.php"><img src="imagens/malvado04.png" alt="Dj Malvado"></a> 
        <p class="paragrafos">DJ Malvado</p>
        <a href="descricao-dj-2.php" class="botao">Reservar</a>
    </div> 

    <div class="linha">
        <a href="dj.php"><img src="imagens/zaques04.png" alt="Fotográfo"></a>
        <p class="paragrafos">DJ Zaques Bantwini</p>
        <a href="descricao-dj-3.php" class="botao">Reservar</a>
    </div> 
</article>
